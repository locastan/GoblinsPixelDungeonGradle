 ...
 */
package com.shatteredpixel.pixeldungeonunleashed.effects.particles;
...
public class Lightnings extends Group {
	...
	public Lightnings(int[] cells, int length, Callback callback) {
