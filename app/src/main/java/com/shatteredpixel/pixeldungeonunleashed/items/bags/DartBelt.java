...
public class DartBelt extends Bag {

	{
		name = "dart belt";
		image = ItemSpriteSheet.DARTBELT;
	...
	public String info() {
		return
			"This thick belt fits around your chest like a sash, it has many small loops to hold your darts.";
	}
}
