...
public class AlchemistsToolkit extends Artifact {
	...
	public static final String AC_BREW = "CATALYZE";
	public static final String AC_COOK = "BREW";
	...
	protected String inventoryTitle = "Select potion:";
	...
	public void guessBrew() {
		...
		if (score == 0){
			...
			if (level == 10){
				...
				GLog.p("The catalyst you've created seems perfect, you don't think there is any way to improve it!");
			} else {
	...
	public String desc() {
		String result = "This toolkit contains a number of reagents and herbs used to improve the process of " +
				"cooking potions and maybe mix them in the field if the catalyst is good enough.\n\n";
