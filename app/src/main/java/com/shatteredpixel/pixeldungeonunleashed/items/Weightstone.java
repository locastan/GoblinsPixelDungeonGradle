...
import com.shatteredpixel.pixeldungeonunleashed.windows.IconTitle;
...
public class Weightstone extends Item {
	...
	public class WndBalance extends Window {
		...
		public WndBalance( final Weapon weapon ) {
			...
			BitmapTextMultiline tfMesage = PixelScene.createMultiline( Utils.format( TXT_CHOICE, weapon.name() ), 8, false );
