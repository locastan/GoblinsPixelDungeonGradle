...
public class ItemSpriteSheet {
	...
	private static final int ROW17 = 256; // 16*16;
    ...
    public static final int DARTBELT 	= ROW15+6;

	//Row Sixteen: Misc
	public static final int EGG	    	= ROW16;
	public static final int EASTEREGG	= ROW16+1;

    //Row Seventeen: Tipped Darts
    public static final int ROT_DART        = ROW17;
    public static final int INCENDIARY_DART = ROW17+1;
    public static final int HOLY_DART       = ROW17+2;
    public static final int BLINDING_DART   = ROW17+3;
    public static final int HEALING_DART    = ROW17+4;
    public static final int CHILLING_DART   = ROW17+5;
    public static final int SHOCKING_DART   = ROW17+6;
    public static final int POISON_DART     = ROW17+7;
    public static final int SLEEP_DART      = ROW17+8;
    public static final int CURARE_DART     = ROW17+9;
    public static final int DISPLACING_DART = ROW17+10;
