...
import com.shatteredpixel.pixeldungeonunleashed.effects.DarkBlock;
...
import com.shatteredpixel.pixeldungeonunleashed.effects.IceBlock;
import com.shatteredpixel.pixeldungeonunleashed.effects.Speck;
import com.shatteredpixel.pixeldungeonunleashed.effects.Splash;
import com.shatteredpixel.pixeldungeonunleashed.effects.TorchHalo;
...
public class CharSprite extends MovieClip implements Tweener.Listener, MovieClip.Listener {
	...
	public static final int GOLDEN      = 0xFFD700;
	public static final int PURPLE      = 0xC000FF;

	private static final float MOVE_INTERVAL	= 0.1f;
	private static final float FLASH_INTERVAL	= 0.05f;
	
	public enum State {
		BURNING, LEVITATING, INVISIBLE, PARALYSED, FROZEN, ILLUMINATED, CHILLED, DARKENED, HEALING
	}
